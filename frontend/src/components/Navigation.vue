<template>
  <b-menu-list>
    ...
    <b-menu-item :expanded="activeGroup.lists" v-if="$root.role.admin" :active="activeGroup.lists"
      data-cy="lists" v-on:update:active="(state) => toggleGroup('lists', state)"
    ...
    <b-menu-item :expanded="activeGroup.campaigns" :active="activeGroup.campaigns"
      ...
      <b-menu-item :to="{name: 'media'}" tag="router-link" v-if="$root.role.admin"
        :active="activeItem.media" data-cy="media" icon="image-outline" :label="$t('menu.media')">
      </b-menu-item>
    ...
    <b-menu-item :expanded="activeGroup.settings" v-if="$root.role.admin"
      ...
      v-on:update:active="(state) => toggleGroup('settings', state)" icon="cog-outline"
